...
TEMPLATE_PROPHET: tuple[SeccionCatalogoProphet, ...] = (
    SeccionCatalogoProphet(
        id="identificacion",
        numero="1",
        nombre="Identificación del modelo",
        obligatoria=True,
    ...
    SeccionCatalogoProphet(
        id="responsables_roles",
        numero="3",
        nombre="Responsables y roles",
        obligatoria=True,
    ...
    SeccionCatalogoProphet(
        id="inputs_dependencias",
        numero="6",
        nombre="Inputs y dependencias",
        obligatoria=True,
        tipo_contenido="tabla",
    ...
    SeccionCatalogoProphet(
        id="componentes_librerias",
        numero="9",
        nombre="Componentes y librerías Prophet",
        obligatoria=False,
        tipo_contenido="texto",
    ...
    SeccionCatalogoProphet(
        id="limitaciones_riesgos",
        numero="11",
        nombre="Limitaciones y riesgos",
        obligatoria=False,
        tipo_contenido="texto",
        intencion="Limitaciones conocidas, dependencias externas críticas y riesgos operacionales.",
    ),
    SeccionCatalogoProphet(
        id="matriz_conocimiento",
        numero="12",
        nombre="Matriz de conocimiento técnico",
        obligatoria=True,
        tipo_contenido="tabla",
